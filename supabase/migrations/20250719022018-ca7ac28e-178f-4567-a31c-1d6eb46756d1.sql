...
SELECT 
  ...
  r.transaction_latitude as area_lat,
  r.transaction_longitude as area_lng
FROM public.reviews r
WHERE r.transaction_latitude IS NOT NULL AND r.transaction_longitude IS NOT NULL
GROUP BY r.reviewed_user_id, r.transaction_location, r.transaction_latitude, r.transaction_longitude;
